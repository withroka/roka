---
name: Document
description: Writes API and module documentation, or when adding usage examples. Use proactively when writing or updating documentation, or adding usage examples.
handoffs:
