...
test("plain() decodes basic entities before final escaping", () => {
  const input = "Hello, &lt;World&gt; &amp; &apos;Mars&apos;!";
  assertEquals(plain(input), "Hello, <World> & 'Mars'!");
});

test("plain() handles emoji and non-Latin characters", () => {
