...
const TESTS = [
  ...
  "compile --target aarch64-unknown-linux-gnu --bundle",
  "compile --target aarch64-unknown-linux-gnu --install=<root>/install",
  "compile --target aarch64-unknown-linux-gnu --concurrency=1",
  "bump",
  "bump --release",
  "bump --changelog=<root>/CHANGELOG.md",
  "bump --changelog=<root>/CHANGELOG.md --emoji",
  "bump --pr",
  "release",
  "release --draft",
  "release --emoji",
